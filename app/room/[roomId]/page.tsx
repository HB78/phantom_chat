  ...
  return (
    <main className="flex h-screen max-h-screen flex-col overflow-hidden">
      ...
      <footer className="border-t border-zinc-800 bg-zinc-900/30 p-4">
        ...
        {isUploadingImage && (
          <div className="mb-3 flex items-center justify-center gap-2 rounded-md border border-green-500/30 bg-green-950/30 py-2">
            <svg
              className="h-4 w-4 animate-spin text-green-400"
